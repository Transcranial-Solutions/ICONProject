#########################################################################
## Project: ICON Network Transaction data                              ##
## Date: July 2021                                                     ##
...
block1 = icon_service.get_block(37090346)
tx1 = icon_service.get_transaction("0xdf0350008fb510e729da678d708c92c0f56dc117b6dcf4b255e686dfac796c30")
txResult1 = icon_service.get_transaction_result("0xdf0350008fb510e729da678d708c92c0f56dc117b6dcf4b255e686dfac796c30")

block2 = icon_service.get_block(37100682)
tx2 = icon_service.get_transaction("0xc3717e2204919ae01f83b8a16d35835ea592ae24280fd3582909cef4bf231ccd")
txResult2 = icon_service.get_transaction_result("0xc3717e2204919ae01f83b8a16d35835ea592ae24280fd3582909cef4bf231ccd")

extract_values(tx, 'from')
extract_values(tx, 'to')



extract_values(txResult, 'indexed')
