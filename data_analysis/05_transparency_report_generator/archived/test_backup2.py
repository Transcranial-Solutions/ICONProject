...
jknown_address.update({'hx6eb81220f547087b82e5a3de175a5dc0d854a3cd': 'unkEx_a1'})
jknown_address.update({'hx0cdf40498ef03e6a48329836c604aa4cea48c454': 'unkEx_a2'})
jknown_address.update({'hx6d14b2b77a9e73c5d5804d43c7e3c3416648ae3d': 'unkEx_a3'})
...
if len(tx_all) != 0:
    ...
    plt.figtext(0.255, 0.96, "flow from " + name_this_address + ' wallet (' + day_today_text + ')', fontsize='large', color='w', ha='left')
