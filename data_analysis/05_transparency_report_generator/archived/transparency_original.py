...
# prep_address = 'hxff1c8ebad1a3ce1ac192abe49013e75db49057f8'
# prep_address = 'hx9f0c84a113881f0617172df6fc61a8278eb540f5' #binance_cold3
...
# u_address = pd.Series(prep_wallet_tx.dest_address.unique())
...
nx.draw(G, pos=nx.nx_pydot.graphviz_layout(G), with_labels=True, node_size=nodesize/1000, alpha=0.3, arrows=True)
