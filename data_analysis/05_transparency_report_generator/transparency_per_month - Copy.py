...
prep_tx_url = Request('https://tracker.icon.foundation/v3/contract/list?count=1000', headers={'User-Agent': 'Mozilla/5.0'})

claimIScoreList?count=1
...
known_contract_url = Request('https://tracker.icon.foundation/v3/contract/list?page=1&count=25', headers={'User-Agent': 'Mozilla/5.0'})
...
# updating other known addresses here --
jknown_address.update({'cxc0b5b52c9f8b4251a47e91dda3bd61e5512cd782': 'TapToken (TAP)'})
