...
plot_vote_change(ymin_mult=1.0, ymax_mult=1.2, # these multiplier to change ylims
                ymin_val=-300000, ymax_val=500000, ytick_scale=100000, # these are actual ylims & tick interval20
...
plot_voter_change(ymin_mult=1.0, ymax_mult=8.3,
                    ymin_val=-1000, ymax_val=1200, ytick_scale=200,
                    first_time_voter_mult=0.99, new_voter_mult=1.08, ## change these
                    top10_1_mult=5.90, top10_2_mult=5.20,
                    topF_1_mult=3.55, topF_2_mult=2.98,
                    title=my_title)
# saving
