...
plot_vote_change(ymin_mult=ymin_mult, ymax_mult=ymax_mult,  # these multiplier to change ylims
                 ymin_val=-2000000, ymax_val=2500000, ytick_scale=500000,
                 # these are actual ylims & tick interval20
                 voter_mult=ymin_mult * 0.99, voter_diff_mult=ymin_mult * 1.08,  # voter change multiplier
...
if run_this == 1:
    ...
    ymax_mult = 2.0
    plot_vote_change(ymin_mult=ymin_mult, ymax_mult=ymax_mult,  # these multiplier to change ylims
                     ymin_val=-1200000, ymax_val=1500000, ytick_scale=300000,
                     # these are actual ylims & tick interval20
